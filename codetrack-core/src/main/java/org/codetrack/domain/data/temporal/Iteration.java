...
/**
 * One Iteration in software development process
 *
 * @author josecmoj at 29/05/15.
 * @see org.codetrack.annotation.temporal.Iteration
 */
@Product(id = "codetrack-core")
@Feature(id = "#4-DATABASE")
public class Iteration extends Temporal {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equal(getCycle(), iteration.getCycle());
    }
