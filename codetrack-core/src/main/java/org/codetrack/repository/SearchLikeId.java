 ...
 */
public class SearchLikeId<T> implements SearchRequest{

    private Class<T> itemClazz;

    private String id;

    private SearchLikeId(Builder builder) {
    ...
    public static Builder newBuilder(SearchLikeId copy) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SearchLikeId)) return false;
        SearchLikeId<?> that = (SearchLikeId<?>) o;
    ...
    public static final class Builder {
        ...
        public SearchLikeId build() {
            return new SearchLikeId(this);
        }
    }
}
